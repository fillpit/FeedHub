...
import { X, FileCode2, Play, BookOpen } from "lucide-react";
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-app-border bg-app-surface/50">
            ...
            <Button
              ...
              size="icon"
              onClick={onClose}
              className="w-8 h-8 text-tx-tertiary hover:text-tx-primary hover:bg-app-hover rounded-lg transition-colors"
            >
              <X size={16} />
            </Button>
          </div>
