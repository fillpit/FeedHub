    ...
    <div class="settings-group">
      ...
      <div v-if="localSettings.bark.enabled" class="service-config">
        <div class="form-row">
          <div class="form-item">
            <label>服务器地址</label>
            <el-input v-model="localSettings.bark.serverUrl" placeholder="https://api.day.app">
              <template #prefix>
          ...
          <div class="form-item">
            <label>设备密钥</label>
            <el-input v-model="localSettings.bark.deviceKey" placeholder="设备密钥" show-password>
              <template #prefix>
                <el-icon><Key /></el-icon>
              </template>
            </el-input>
        ...
        <div class="form-row">
          ...
          <div class="form-item">
            <label>分组</label>
            <el-input v-model="localSettings.bark.group" placeholder="通知分组（可选）" />
          </div>
        </div>
      ...
      <div v-if="localSettings.email.enabled" class="service-config">
        <div class="form-row">
          <div class="form-item">
            ...
            <el-input v-model="localSettings.email.smtpHost" placeholder="smtp.gmail.com">
              <template #prefix>
        ...
        <div class="form-row">
          <div class="form-item">
            <label>用户名</label>
            <el-input v-model="localSettings.email.username" placeholder="邮箱用户名">
              <template #prefix>
        ...
        <div class="form-row">
          <div class="form-item">
            <label>发件人邮箱</label>
            <el-input v-model="localSettings.email.fromEmail" placeholder="sender@example.com">
              <template #prefix>
          ...
          <div class="form-item">
            <label>收件人邮箱</label>
            <el-input v-model="localSettings.email.toEmail" placeholder="receiver@example.com">
              <template #prefix>
                <el-icon><Message /></el-icon>
              </template>
            </el-input>
    ...
    <div class="settings-group">
      ...
      <div v-if="localSettings.gotify.enabled" class="service-config">
        <div class="form-row">
          ...
          <div class="form-item">
            <label>应用令牌</label>
            <el-input v-model="localSettings.gotify.appToken" placeholder="应用令牌" show-password>
              <template #prefix>
                <el-icon><Key /></el-icon>
              </template>
            </el-input>
    ...
    <div class="settings-group">
      ...
      <div v-if="localSettings.dingtalk.enabled" class="service-config">
        ...
        <div class="form-row">
          <div class="form-item">
            <label>签名密钥（可选）</label>
            <el-input v-model="localSettings.dingtalk.secret" placeholder="签名密钥" show-password>
              <template #prefix>
                <el-icon><Key /></el-icon>
              </template>
            </el-input>
    ...
    <div class="settings-group">
      ...
      <div v-if="localSettings.feishu.enabled" class="service-config">
        ...
        <div class="form-row">
          <div class="form-item">
            <label>签名密钥（可选）</label>
            <el-input v-model="localSettings.feishu.secret" placeholder="签名密钥" show-password>
              <template #prefix>
                <el-icon><Key /></el-icon>
              </template>
            </el-input>
          ...
          <div class="form-item">
            <label>@所有人</label>
            <el-switch v-model="localSettings.feishu.atAll" active-text="是" inactive-text="否" />
          </div>
        </div>
...
const testNotification = async (service: string) => {
  ...
  try {
    ...
    if (response.data?.success) {
      ...
      ElMessage.error(
        `${getServiceName(service)} 测试失败: ${response.data?.message || "未知错误"}`
      );
    }
  } catch (error: any) {
