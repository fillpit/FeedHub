<template>
  <div class="file-tree-node">
    ...
    >
      <!-- 展开/折叠箭头 -->
      <div class="expand-arrow" v-if="node.type === 'directory'" @click.stop="toggleExpanded">
        <svg
          class="arrow-icon"
      ...
      <div class="file-icon">
        ...
        >
          <path
            v-if="!isExpanded"
            d="M1.5 3A1.5 1.5 0 0 1 3 1.5h3.879a1.5 1.5 0 0 1 1.06.44l1.122 1.12A.5.5 0 0 0 9.415 3.5H13A1.5 1.5 0 0 1 14.5 5v8a1.5 1.5 0 0 1-1.5 1.5H3A1.5 1.5 0 0 1 1.5 13V3z"
            fill="#dcb67a"
          />
          <path
            v-else
          ...
          <path
            v-if="isExpanded"
            d="M1.5 4.5h13v8a1 1 0 0 1-1 1h-11a1 1 0 0 1-1-1v-8z"
            fill="#b8a082"
          />
        </svg>
        ...
        <template v-else>
          <!-- JavaScript 文件 -->
          <svg
            v-if="node.extension === '.js'"
            class="file-icon-svg js"
            width="16"
            height="16"
            viewBox="0 0 16 16"
          >
          ...
          <!-- JSON 文件 -->
          <svg
            v-else-if="node.extension === '.json'"
            class="file-icon-svg json"
            width="16"
            height="16"
            viewBox="0 0 16 16"
          >
          ...
          <!-- TypeScript 文件 -->
          <svg
            v-else-if="node.extension === '.ts'"
            class="file-icon-svg ts"
            width="16"
            height="16"
            viewBox="0 0 16 16"
          >
          ...
          <!-- CSS 文件 -->
          <svg
            v-else-if="node.extension === '.css'"
            class="file-icon-svg css"
            width="16"
            height="16"
            viewBox="0 0 16 16"
          >
          ...
          <!-- HTML 文件 -->
          <svg
            v-else-if="node.extension === '.html'"
            class="file-icon-svg html"
            width="16"
            height="16"
            viewBox="0 0 16 16"
          >
          ...
          <!-- Markdown 文件 -->
          <svg
            v-else-if="node.extension === '.md'"
            class="file-icon-svg md"
            width="16"
            height="16"
            viewBox="0 0 16 16"
          >
      ...
      <div
        ...
        "
      >
        <button class="action-btn delete-btn" @click.stop="handleDelete" title="删除文件">
          <svg width="14" height="14" viewBox="0 0 16 16">
            <path
              d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 1.152l.557 10.032A1.5 1.5 0 0 0 4.55 15h6.9a1.5 1.5 0 0 0 1.497-1.316l.557-10.032a.58.58 0 0 0-.01-1.152H11Z"
              fill="currentColor"
            />
          </svg>
        </button>
