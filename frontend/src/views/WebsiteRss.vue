    ...
    <div class="main-content">
      ...
      <ul class="feed-list" v-loading="configsLoading">
        <li
          ...
          :key="config.id"
          @click="config.key && copyRssLink(config.key, 'rss')"
        >
          <div class="feed-item">
            ...
            <div class="feed-info">
              ...
              <div v-if="config.key" class="feed-rss-url">
                ...
                <el-icon style="cursor: pointer" @click.stop="copyRssLink(config.key, 'rss')"
                  ><CopyDocument
                /></el-icon>
              </div>
              <div v-if="config.key" class="feed-json-url">
                <span>JSON链接: {{ getJsonUrl(config.key) }}</span>
                <el-icon style="cursor: pointer" @click.stop="copyRssLink(config.key, 'json')"
                  ><CopyDocument
                /></el-icon>
              </div>
            </div>
