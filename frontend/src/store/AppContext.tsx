...
function getSavedViewMode(): ViewMode {
  try {
    ...
    const validModes: ViewMode[] = ["dashboard", "notebook", "favorites", "trash", "all", "search", "tasks", "tag", "mindmaps", "ai-chat", "diary", "codex", "admin", "feed-routes", "feed-websites", "feed-credentials"];
